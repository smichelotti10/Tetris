...
void get_input (ALLEGRO_EVENT *event, ALLEGRO_EVENT_QUEUE *event_queue, ALLEGRO_SAMPLE*sound, pieza_t* in_use, pieza_t* hold, pieza_t* to_use,
                int mat[FIL][COL], char*end, ALLEGRO_FONT* font, game_stats_t* jugador);
